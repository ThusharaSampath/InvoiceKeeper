...
//removed Expire date TODO expire date of cheque
	public static Cheque createCheque(String chequeNo_C,Long DealerID,String DealerName,String invoiceNo_C,long chequeAmount, String chequeDate,  int chequeExpireStatus,
			int chequePassStatus) {
	...
	public static void saveCheque(String chequeNo_C,String DealerName,String invoiceNo_C,long chequeAmount, String chequeDate){
